      ...
      private void _FillCountriesInComboBox()
        ...
        private void _LoadData()
        {
           ...
           _Contact = clsContact.Find(_ContactID);
            ...
            cbCountry.SelectedIndex = cbCountry.FindString(clsCountries.FindByID(_Contact.CountryID).CountryName);
        ...
        {
            int CountryID = clsCountries.FindByName(cbCountry.Text).CountryID;
